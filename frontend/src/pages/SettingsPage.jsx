...
import { Copy, RefreshCw, Sun } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in" data-testid="settings-page">
      ...
      <Card className="border-border bg-card">
        ...
        <CardContent className="space-y-5">
          <div className="flex items-center justify-between gap-4 rounded-xl border border-border bg-accent/40 px-4 py-4">
            <div className="space-y-1">
              <Label className="text-sm font-medium">Theme Mode</Label>
              <p className="text-sm text-muted-foreground">
                Dark mode has been disabled for a cleaner, fixed dashboard experience.
              </p>
            </div>
            <div className="flex shrink-0 items-center gap-2 rounded-full bg-accent px-3 py-1.5 text-sm font-medium text-primary">
      ...
      <Card className="border-border bg-card">
        <CardHeader>
          <CardTitle className="text-lg font-bold tracking-tight">Client Invite Code</CardTitle>
