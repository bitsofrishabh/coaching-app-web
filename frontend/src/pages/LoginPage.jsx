      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/10 via-background to-background items-center justify-center p-12">
        <div className="max-w-md animate-fade-in">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-3xl font-bold text-foreground">NutriTrack Pro</span>
          </div>
        ...
        <Card className="w-full max-w-md border-border bg-card animate-slide-in">
          <CardHeader className="space-y-1 pb-6">
            <div className="lg:hidden flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">NutriTrack Pro</span>
            </div>
            <CardTitle className="text-2xl font-bold">
              {isRegister ? "Create account" : "Welcome back"}
            </CardTitle>
            <CardDescription>
              {isRegister ? "Start your journey with NutriTrack Pro" : "Sign in to your account to continue"}
            </CardDescription>
          </CardHeader>
          <CardContent>
